...
class FileControllerIT {
    ...
    void shouldReturnFiles() throws Exception {
        ...
        mockMvc.perform(get("/api/files"))
               ...
               .andExpect(jsonPath("$.content[0].hashCalculationDateTime", is("2019-10-09T12:59:00.646819Z")))
               ...
               .andExpect(jsonPath("$.content[1].hashCalculationDateTime", is("2019-10-10T12:59:00.646819Z")));
